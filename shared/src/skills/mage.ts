...
const MAGE_TRUNK: SkillDefinition[] = [
  ...
  },
  {
    ...
    job: 'mage',
    name: '대마법',
    description: '순간적으로 마법 이해도를 극한까지 끌어올립니다. (25초간 지능 증가, 자신 또는 대상에게 시전)',
    requiredLevel: 6,
    kind: 'buff',
    mpCost: 8,
    power: 8,
  ...
  },
  {
    ...
    job: 'mage',
    name: '정신 수양',
    description: '정신을 집중해 마법에 대한 이해를 넓힙니다. (30초간 지혜 증가, 자신 또는 대상에게 시전)',
    requiredLevel: 9,
    kind: 'buff',
    mpCost: 8,
    power: 6,
  ...
  },
  {
    ...
    job: 'mage',
    name: '정신 방벽',
    description: '정신력으로 보이지 않는 방벽을 두릅니다. (35초간 마법방어 증가, 자신 또는 대상에게 시전)',
    requiredLevel: 12,
    kind: 'buff',
    mpCost: 9,
    power: 6,
