...
const WARRIOR_TRUNK: SkillDefinition[] = [
  ...
  },
  {
    ...
    job: 'warrior',
    name: '강철 피부',
    description: '피부를 강철처럼 단련합니다. (20초간 물리방어 증가, 자신 또는 대상에게 시전)',
    requiredLevel: 3,
    kind: 'buff',
    mpCost: 5,
    power: 4,
  ...
  },
  {
    ...
    job: 'warrior',
    name: '완력 강화',
    description: '근력을 극한까지 끌어올립니다. (30초간 힘 증가, 자신 또는 대상에게 시전)',
    requiredLevel: 9,
    kind: 'buff',
    mpCost: 6,
    power: 6,
  ...
  },
  {
    ...
    job: 'warrior',
    name: '전투 본능',
    description: '전투 본능을 일깨워 반응 속도가 빨라집니다. (35초간 민첩 증가, 자신 또는 대상에게 시전)',
    requiredLevel: 12,
    kind: 'buff',
    mpCost: 7,
    power: 5,
  ...
  },
  {
    ...
    job: 'warrior',
    name: '백전노장의 관록',
    description: '전장의 경험을 끌어내 몸이 근본부터 단단해집니다. (45초간 체력 증가, 자신 또는 대상에게 시전)',
    requiredLevel: 16,
    kind: 'buff',
    mpCost: 8,
    power: 10,
