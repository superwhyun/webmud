...
const ROGUE_TRUNK: SkillDefinition[] = [
  ...
  },
  {
    ...
    job: 'rogue',
    name: '그림자 걸음',
    description: '그림자처럼 가볍게 움직입니다. (20초간 민첩 증가, 자신 또는 대상에게 시전)',
    requiredLevel: 2,
    kind: 'buff',
    mpCost: 5,
    power: 5,
  ...
  },
  {
    ...
    job: 'rogue',
    name: '백발백중',
    description: '치명적인 순간을 놓치지 않도록 감각을 벼립니다. (25초간 행운 증가, 자신 또는 대상에게 시전)',
    requiredLevel: 6,
    kind: 'buff',
    mpCost: 5,
    power: 5,
  ...
  },
  {
    ...
    job: 'rogue',
    name: '쾌속 이동',
    description: '발걸음이 바람처럼 가벼워집니다. (30초간 민첩 증가, 자신 또는 대상에게 시전)',
    requiredLevel: 9,
    kind: 'buff',
    mpCost: 6,
    power: 6,
  ...
  },
  {
    ...
    job: 'rogue',
    name: '정신 단련',
    description: '정신을 집중해 마법 공격에도 흔들리지 않게 됩니다. (30초간 마법방어 증가, 자신 또는 대상에게 시전)',
    requiredLevel: 10,
    kind: 'buff',
    mpCost: 6,
    power: 25,
  ...
  },
  {
    ...
    job: 'rogue',
    name: '야수의 감각',
    description: '야수와 같은 감각을 끌어내 약점을 간파합니다. (35초간 행운 증가, 자신 또는 대상에게 시전)',
    requiredLevel: 12,
    kind: 'buff',
    mpCost: 7,
    power: 6,
  ...
  },
  {
    ...
    job: 'rogue',
    name: '암살자의 완숙',
    description: '암살자의 감각을 순간적으로 끌어올립니다. (45초간 힘 증가, 자신 또는 대상에게 시전)',
    requiredLevel: 16,
    kind: 'buff',
    mpCost: 8,
    power: 8,
