...
export function showHelp(ctx: CommandContext): void {
  ctx.send({
    ...
    text: [
      ...
      'enter (입장) <이름> (e) - 방에 있는 연결점(포털)을 통해 이동합니다.',
      '',
      '[소통]',
      ...
      '',
      '[전투]',
      'attack (공격) <대상> - 몬스터를 공격합니다.',
      'consider (con) <몬스터> - 상대가 나에게 얼마나 위협적인지 가늠해봅니다.',
      'flee - 전투에서 도망칩니다.',
      'rest (휴식) - 자리를 잡고 쉬며 체력/마나를 서서히 회복합니다. (전투하거나 이동하면 중단)',
      'cast (마법) <스킬 ID> - 배운 스킬을 사용합니다. (전투 중: 공격기 / 평시에도 가능: 회복기)',
      '마법 <스킬 이름> [대상] - 스킬 이름으로 편하게 사용합니다. 예) 마법 파이어볼 써, 마법 파이어볼 고블린',
      '  전투 중이 아니어도 대상을 지정하면 공격기로 선공을 걸 수 있습니다.',
      '',
      '[아이템]',
      'get/drop <아이템> - 아이템을 줍거나 버립니다.',
      'give <아이템> <플레이어> - 같은 방에 있는 유저에게 아이템을 건네줍니다.',
      'examine (ex) <대상> - 몬스터/NPC/아이템을 자세히 살펴봅니다.',
