...
export function showHelp(ctx: CommandContext): void {
  ctx.send({
    ...
    text: [
      ...
      'skill learn <스킬 ID> - 스킬 포인트로 스킬을 배웁니다. (선행 스킬/속성 조건이 있을 수 있음)',
      'skill upgrade <스킬 ID> - 스킬 포인트로 배운 스킬의 랭크를 올립니다. (최대 랭크 20)',
      'skill reset - 배운 스킬을 전부 초기화하고 사용한 스킬 포인트를 전액 돌려받습니다.',
